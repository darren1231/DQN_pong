...
#            action_index_2 = np.argmax(cost_out)
#            
#            
#            number_1=readout_t[action_index_1]
#            number_2=cost_out[action_index_2]            
#            
...
#                    r_batch_temp[i]=0
                ...
                # if terminal only equals reward
                if minibatch[i][4]:
                    y_batch_cost.append(r_batch_temp[i])
                else:
                    #y_batch.append(r_batch[i] + GAMMA * np.max(readout_j1_batch[i]))
                    y_batch_cost.append(r_batch_temp[i] + GAMMA * np.max(readout_j1_batch[i]))
...
def playGame():
    ...
    s_cost,readout_cost,h_fc1_cost = copy_createNetwork()
