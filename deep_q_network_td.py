...
def trainNetwork(s, readout, h_fc1, sess,merged,writer):
    ...
    while True:
        ...
        sum_td_error=sum_td_error+TD_error
        
        hit = normal_distribution(15,abs(normalization_td))
        change_speed = hit
        
        step=step+1
        
        if step ==10000:
            normalization_td=(sum_td_error-40)/360
            
            
            episode=episode+1            
            e_file.write(str(episode)+','+str(sum_td_error)+'\n')
            sum_td_error=0
            step=0
        ...
        if t % 500 == 0:  
            ...
            +','+time_text+','+str(TD_error)+','+str(change_speed)+','+str(normalization_td)+'\n')
        ...
        ,' ',episode,sum_td_error,change_speed
        # write info to files
