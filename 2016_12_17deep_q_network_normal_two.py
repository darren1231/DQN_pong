...
store_network_path="temp/normal_networks/"
store_network_path2="temp/cost_networks/"
...
if os.path.exists('temp'):
    ...
    os.makedirs(store_network_path2)
...
#                a_t[action_index_2] = 1
        ...
        if t % 10000 == 0:
            ...
            saver.save(sess2, store_network_path2 + GAME + '-dqn', global_step = t+pretrain_number)
